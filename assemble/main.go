...
/**
hxzhouh@hxzhouh:~/workspace/study_mod/assemble$ go tool compile -l  -N -S main.go
"".main STEXT size=86 args=0x0 locals=0x18
        ...
        0x001d 00029 (main.go:5)        PCDATA  $1, $0
        0x001d 00029 (main.go:5)        NOP
        0x0020 00032 (main.go:5)        CALL    runtime.printlock(SB)
        0x0025 00037 (main.go:5)        LEAQ    go.string."hello,world"(SB), AX
        0x002c 00044 (main.go:5)        MOVQ    AX, (SP)
        0x0030 00048 (main.go:5)        MOVQ    $11, 8(SP)
        0x0039 00057 (main.go:5)        CALL    runtime.printstring(SB)
        0x003e 00062 (main.go:5)        NOP
        0x0040 00064 (main.go:5)        CALL    runtime.printunlock(SB)
        0x0045 00069 (main.go:6)        MOVQ    16(SP), BP
        0x004a 00074 (main.go:6)        ADDQ    $24, SP
        0x004e 00078 (main.go:6)        RET
        0x004f 00079 (main.go:6)        NOP
        0x004f 00079 (main.go:4)        PCDATA  $1, $-1
        0x004f 00079 (main.go:4)        PCDATA  $0, $-2
        0x004f 00079 (main.go:4)        CALL    runtime.morestack_noctxt(SB)
        0x0054 00084 (main.go:4)        PCDATA  $0, $-1
        0x0054 00084 (main.go:4)        JMP     0
